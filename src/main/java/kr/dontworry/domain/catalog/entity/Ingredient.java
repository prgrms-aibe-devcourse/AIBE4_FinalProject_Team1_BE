package kr.dontworry.domain.catalog.entity;

import jakarta.persistence.*;
import kr.dontworry.domain.catalog.entity.enums.IngredientStatus;
import kr.dontworry.domain.catalog.entity.enums.IngredientUnit;
