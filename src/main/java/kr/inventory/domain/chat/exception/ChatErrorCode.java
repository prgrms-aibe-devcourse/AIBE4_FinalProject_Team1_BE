...
public enum ChatErrorCode implements ErrorModel {
    ...
    ALREADY_INTERRUPTED(HttpStatus.BAD_REQUEST, "C015", "이미 중단 처리된 요청입니다."),

    UNKNOWN_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "C016", "알 수 없는 오류가 발생했습니다."),
    ASSISTANT_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "C017", "답변을 생성하지 못했습니다.");
