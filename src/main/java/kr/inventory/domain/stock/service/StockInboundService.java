...
// import kr.inventory.domain.purchase.repository.VendorRepository;
import kr.inventory.domain.stock.controller.dto.StockInboundRequest;
import kr.inventory.domain.stock.controller.dto.StockInboundResponse;
...
public class StockInboundService {
	...
	//     Document sourceDocument = request.sourceDocumentId() != null ? documentRepository.findById(request.sourceDocumentId())
	//             .orElse(null) : null;
	//     PurchaseOrder sourcePurchaseOrder = request.sourcePurchaseOrderId() != null ? purchaseOrderRepository.findById(request.sourcePurchaseOrderId())
	//             .orElse(null) : null;
	//
	...
	// public StockInboundResponse getInbound(Long inboundId) {
	//     StockInbound inbound = stockInboundRepository.findById(inboundId)
	...
	// }
	//
	// public void confirmInbound(Long inboundId, Long userId) {
	//     StockInbound inbound = stockInboundRepository.findById(inboundId)
	//             .orElseThrow(() -> new StockException(StockErrorCode.INBOUND_NOT_FOUND));
	//
	...
	// }
	//
	// public void deleteInbound(Long inboundId) {
	//     StockInbound inbound = stockInboundRepository.findById(inboundId)
	//             .orElseThrow(() -> new StockException(StockErrorCode.INBOUND_NOT_FOUND));
	//
	//     if (inbound.getStatus() != InboundStatus.DRAFT) {
