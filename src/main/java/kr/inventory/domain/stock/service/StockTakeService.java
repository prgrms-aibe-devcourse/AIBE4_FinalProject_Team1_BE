...
public class StockTakeService {
	...
	@Transactional
	public void saveStockTakeDraft(Long userId, UUID storePublicId, UUID sheetPublicId,
		StockTakeDraftSaveRequest request) {
		Long storeId = storeAccessValidator.validateAndGetStoreId(userId, storePublicId);
	...
	@Transactional
	public void confirmStockTakeSheet(Long userId, UUID storePublicId, UUID sheetPublicId,
		StockTakeConfirmRequest request) {
		Long storeId = storeAccessValidator.validateAndGetStoreId(userId, storePublicId);
	...
	private List<StockTake> buildDraftItems(Long storeId, StockTakeSheet sheet,
		List<StockTakeItemQuantityRequest> itemRequests) {
