...
public class PurchaseOrderController {
        ...
        public ResponseEntity<PurchaseOrderDetailResponse> create(
                ...
                PurchaseOrderDetailResponse response = purchaseOrderService.create(principal.getUserId(), storePublicId,
                                request);
        ...
        public ResponseEntity<PurchaseOrderDetailResponse> getDetail(
                        ...
                        @AuthenticationPrincipal CustomUserDetails principal) {
                PurchaseOrderDetailResponse response = purchaseOrderService.getPurchaseOrder(principal.getUserId(),
        ...
        public ResponseEntity<PurchaseOrderDetailResponse> update(
                ...
                PurchaseOrderDetailResponse response = purchaseOrderService.update(principal.getUserId(), storePublicId,
        ...
        public ResponseEntity<PurchaseOrderDetailResponse> cancel(
                        ...
                        @PathVariable UUID purchaseOrderPublicId,
                        @AuthenticationPrincipal CustomUserDetails principal) {
                PurchaseOrderDetailResponse response = purchaseOrderService.cancel(principal.getUserId(), storePublicId,
        ...
        public ResponseEntity<byte[]> downloadPdf(
                        ...
                        @PathVariable UUID purchaseOrderPublicId,
                        @AuthenticationPrincipal CustomUserDetails principal) {
                byte[] pdfBytes = purchaseOrderService.downloadPdf(principal.getUserId(), storePublicId,
                                purchaseOrderPublicId);
