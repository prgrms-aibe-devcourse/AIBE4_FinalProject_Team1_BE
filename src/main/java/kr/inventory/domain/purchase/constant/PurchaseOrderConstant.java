...
public final class PurchaseOrderConstant {
    ...
    public static final String PDF_STATUS_LABEL = "상태: ";

    // 상태 레이블
    public static final String PDF_STATUS_ORDERED = "발주 완료";
    public static final String PDF_STATUS_CANCELED = "발주 취소";

    // 테이블 헤더
    public static final String PDF_TABLE_HEADER_ITEM_NAME = "품목명";
    public static final String PDF_TABLE_HEADER_QUANTITY = "수량";
    public static final String PDF_TABLE_HEADER_UNIT = "단위";
    ...
    // 테이블 컬럼 너비 비율 (총합 1.0)
    public static final float PDF_TABLE_COL_ITEM_NAME_RATIO = 0.35f;  // 35%
    public static final float PDF_TABLE_COL_QUANTITY_RATIO = 0.12f;   // 12%
    public static final float PDF_TABLE_COL_UNIT_RATIO = 0.12f;       // 12%
    public static final float PDF_TABLE_COL_UNIT_PRICE_RATIO = 0.205f; // 20.5%
    public static final float PDF_TABLE_COL_LINE_AMOUNT_RATIO = 0.205f; // 20.5%
